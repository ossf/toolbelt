# Contributing to the OpenSSF Security Toolbelt

Welcome! We're excited that you're interested in contributing to the Security Toolbelt. We aim to create a supportive, inclusive environment where everyone can thrive and make meaningful contributions.
...
- **Slack Channel:** Join the conversation on our # [OpenSSF Slack channel](https://openssf.slack.com/archives/C057BN7K19B). This is the best place to ask questions, share ideas, and collaborate.

- **Mailing List:** Subscribe to the Best Practices [mailing list](Openssf-sig-sterling-toolchain@lists.openssf.org). You can also [manage your subscriptions](https://lists.openssf.org/g/main/subgroups) to all OpenSSF mailing lists.
...
- Join our #security-toolbelt channel via the [OpenSSF Slack channel](https://openssf.slack.com/archives/C057BN7K19B).

- Attend working group meetings listed on the public calendar.

### 2. Report Issues or Suggest Enhancements

- Use the [GitHub Issues](https://github.com/ossf/toolbelt/issues) tab to report problems or suggest ideas.
- Follow our issue template to provide clear and detailed information.
- Check out our [Discussions](https://github.com/ossf/toolbelt/discussions).
...
We are committed to maintaining a welcoming, inclusive, and respectful environment. Please read and follow our [Code of Conduct](https://github.com/ossf/toolbelt/blob/main/code-of-conduct.md) to ensure a positive experience for everyone.
