...
### Role: 
- security champion
- accomplishes threat modeling
- ensures good security controls are in place on the products (e.g. vulnerability remediation)

### Background:
-Works at an enterprise embedded in the engineering team implementing product security standards, controls and SDLC.

//Baha start here please//
#### Possible spectrum of experience:
- Job to do this
- In security and job is to notice
- Not a job, a hobby or accidental discovery
